...
class UserPersistenceFileTestCase(unittest.TestCase):
    def setUp(self) -> None:
        self.user_persistence_file = UserPersistenceFile("user_test.json")

    def test_get_all_gets_empty_list_if_database_is_empty(self):
        # execution
        all_users = self.user_persistence_file.get_all()
    ...
    def test_it_adds_a_user(self):
        ...
        # execution
        self.user_persistence_file.add(self.new_user)
        actual_new_user = [u.username for u in self.user_persistence_file.get_all()]
    ...
    def test_it_delete_a_user(self):
        ...
        # execution
        self.user_persistence_file.delete(str(self.new_user.id))
        all_users = self.user_persistence_file.get_all()
    ...
    def test_it_updates_a_user(self):
        ...
        self.user_persistence_file.update(str(self.new_user.id), actual_new_username)
        all_usernames = [u.username for u in self.user_persistence_file.get_all()]
